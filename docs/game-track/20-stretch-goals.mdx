  ...
  return (
    <>
      ...
      <Canvas style={{ position: "absolute", inset: "0", touchAction: "none" }}>
        <XR store={store}>
            <Bullets />
            <Gltf src="https://immersive-react.com/spacestation.glb" />
            <Target targetIdx={0} />
            <Target targetIdx={1} />
            <Target targetIdx={2} />
            <Score />
...
function Bullet({ bulletData }: { bulletData: BulletData }) {
    ...
    const { scene } = useGLTF("https://immersive-react.com/blaster.glb");
...
function Gun() {
  ...
  useXRControllerButtonEvent(state, "xr-standard-trigger", (state) => {
    ...
    return <>
        <PositionalAudio ref={soundRef} url="https://immersive-react.com/laser.ogg" loop={false} />
        <primitive object={scene} />
    </>
};
useGLTF.preload("https://immersive-react.com/blaster.glb");
...
export const Target = ({ targetIdx }: { targetIdx: number; }) => {
  const { scene } = useGLTF("https://immersive-react.com/target.glb");
...
export function Score() {
  ...
  return (
    ...
    >
      ...
      <PositionalAudio ref={soundRef} url="https://immersive-react.com/score.ogg" loop={false} />
    </Text>
  );
};`}}/>