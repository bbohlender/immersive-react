...
For this workshop we offer you to either develop in a Codesandbox that is preconfigured for each part or clone a github repository and develop locally.

> [!NOTE]
> If you prefer programming in your local development environment, clone `https://github.com/bbohlender/ir-introduction-to-react-three-fiber-baseline.git`.
